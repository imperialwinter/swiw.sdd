...
gadget.baseBuildOrder = {
	...
	["rebel alliance"] = UnitArray{
		...
		"reb_i_rockettrooper",  "reb_p_fusion", "reb_i_rockettrooper",
		"reb_b_airplant", "reb_p_fusion", "reb_i_rockettrooper",
		"reb_b_airplant", "reb_p_fusion", "reb_p_fusion",
		"reb_i_rockettrooper", "reb_p_fusion", "reb_b_airplant",
		"reb_p_fusion", "reb_b_barracks", "reb_d_golan",
		"reb_d_golan", "reb_d_golan", "reb_p_fusion",
		"reb_b_airplant", "reb_i_sniper", "reb_p_fusion",
		"reb_d_atgar", "reb_p_fusion", "reb_i_sniper",
		"reb_b_barracks", "reb_p_fusion", "reb_i_rockettrooper",
		"reb_d_atgar", "reb_p_fusion", "reb_i_rockettrooper",
		"reb_b_repulsorliftplant", "reb_p_fusion", "reb_i_sniper",
		"reb_b_barracks", "reb_b_repulsorliftplant", "reb_i_rockettrooper",
		"reb_d_atgar", "reb_p_fusion", "reb_i_rockettrooper",
	},
}
